...
(function () {
    ...
    if (typeof Date.prototype.toJSON !== "function") {
        Date.prototype.toJSON = function (key) {
            return isFinite(this.valueOf())if (window.JSON && window.JSON.stringify.toString().indexOf("[native code]") !== -1) {
                window.JSONYoudao = window.JSON
            } else {
                window.JSONYoudao = {}
            }
            ...
            (function () {
                var YoudaoUtils = {
                    ...
                    url: function () {
                        ...
                        if (!!location && location.href !== undefined)
            ...
            (function (YD) {
                function Config() {
                    ...
                    function initInternal(fullWidth, fullHeight, firstTime) {
                        ...
                        if (firstTime === true) {
                            if (fullHeight < 180)
                                heightSet.origin = 180;
                            else
                                heightSet.origin = fullHeight
                        }
                        if (this.title === "off") {
                            if (fullHeight < 80) {
                                fullHeight = 80
            ...
            (function (YD, config) {
                function UI() {
                    ...
                    function applyConfig(iframeDocument, firstTime) {
                        ...
                        YD.css(iframeDocument.getElementById("youdaoDictMain"), {
                            height: config.getHeight("full") + "px"
                        });
                        var top = iframeDocument.getElementById("youdaoDictTop");
                        if (top !== null) {
                            YD.css(iframeDocument.getElementById("youdaoDictTop"), {
                    ...
                    this.resize = function () {
                        ...
                        YD.css(YOUDAO_SELECTOR_IFRAME, {
                            width: innerWidth + "px",
                            height: innerHeight + 2 + "px"
                        });
                        YD.css(YOUDAO_SELECTOR_WRAPPER, {
                            width: innerWidth + "px",
                            height: innerHeight + 2 + "px"
                        })
                    }
            ...
            (function (YD, config, ui, dataRender) {
                function YoudaoSelector() {
                    ...
                    function selectTrans(pos, target) {
                        ...
                        q = YD.trim(q);
                        if (q === "") { } else {
                            if (q.length > 200) { } else if (q.length > 40) {
